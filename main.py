...
if __name__ == '__main__':
    ...
    transforms.Normalize(mean=[0.5], std=[0.5]) # 标准化至[-1, 1]，规定均值和标准差
...
# mean=[0.17], std=[0.05]
    ...
    validate_dataset = data= datasets.ImageFolder(root="D:/MPTF/02+/In/Val",
    ...
    model_weight_path = "./MobileNetV3_Small01.pth"
